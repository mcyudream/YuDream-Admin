...
public class BlessingSkinUserController {

    private final BlessingSkinHttpFacade http;

    public BlessingSkinUserController(BlessingSkinHttpFacade http) {
        this.http = http;
    }

    @PluginHttpEndpoint(method = "GET", path = "/me", permission = BlessingSkinPlugin.USER_PERMISSION)
    public PluginHttpResponse me(PluginHttpRequest request) {
        return http.me(request);
    }

    @PluginHttpEndpoint(method = "GET", path = "/me/players", permission = BlessingSkinPlugin.USER_PERMISSION)
    public PluginHttpResponse myPlayers(PluginHttpRequest request) {
        return http.myPlayers(request);
    }

    @PluginHttpEndpoint(method = "POST", path = "/me/players", permission = BlessingSkinPlugin.USER_PERMISSION)
    public PluginHttpResponse createMyPlayer(PluginHttpRequest request) {
        return http.createMyPlayer(request);
    }

    @PluginHttpEndpoint(method = "PUT", path = "/me/players/{name}/name", permission = BlessingSkinPlugin.USER_PERMISSION)
    public PluginHttpResponse renameMyPlayer(PluginHttpRequest request) {
        return http.renameMyPlayer(request);
    }

    @PluginHttpEndpoint(method = "PUT", path = "/me/players/{name}/textures", permission = BlessingSkinPlugin.USER_PERMISSION)
    ...
    @PluginHttpEndpoint(method = "POST", path = "/me/textures", permission = BlessingSkinPlugin.USER_PERMISSION)
    public PluginHttpResponse uploadMyTexture(PluginHttpRequest request) {
        return http.uploadMyTexture(request);
    }

    @PluginHttpEndpoint(method = "GET", path = "/me/closet", permission = BlessingSkinPlugin.USER_PERMISSION)
    public PluginHttpResponse myCloset(PluginHttpRequest request) {
        return http.myCloset(request);
    }

    @PluginHttpEndpoint(method = "POST", path = "/me/closet", permission = BlessingSkinPlugin.USER_PERMISSION)
    public PluginHttpResponse saveMyClosetItem(PluginHttpRequest request) {
        return http.saveMyClosetItem(request);
    }

    @PluginHttpEndpoint(method = "PUT", path = "/me/closet/{id}", permission = BlessingSkinPlugin.USER_PERMISSION)
    public PluginHttpResponse renameMyClosetItem(PluginHttpRequest request) {
        return http.renameMyClosetItem(request);
    }

    @PluginHttpEndpoint(method = "DELETE", path = "/me/closet/{id}", permission = BlessingSkinPlugin.USER_PERMISSION)
