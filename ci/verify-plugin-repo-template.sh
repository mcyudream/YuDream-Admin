...
grep -q "'@yudream/components': 1.2.1$" templates/plugin-repo/pnpm-workspace.yaml.example || fail "template must consume stable @yudream/components 1.2.1"
grep -q "'@yudream/plugin-sdk': 1.3.0$" templates/plugin-repo/pnpm-workspace.yaml.example || fail "template must consume stable @yudream/plugin-sdk 1.3.0"
