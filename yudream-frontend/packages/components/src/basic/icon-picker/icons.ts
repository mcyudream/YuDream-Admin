export interface YdIconOption {
  name: string
  keywords: string
}

export const YD_ICON_PREFIX = 'i-ri:'

export const YD_ICON_FREQUENT: string[] = [
  'i-ri:apps-2-line',
  'i-ri:home-4-line',
  'i-ri:menu-2-line',
...
/** Remix Icon 全量清单，由 @iconify/json ri.json 生成。 */
const YD_ICON_IDS: string[] = [
  '24-hours-fill',
  '24-hours-line',
  '4k-fill',
  '4k-line',
...
export const YD_ICON_CATALOG: YdIconOption[] = YD_ICON_IDS.map(id => ({
  name: `${YD_ICON_PREFIX}${id}`,
