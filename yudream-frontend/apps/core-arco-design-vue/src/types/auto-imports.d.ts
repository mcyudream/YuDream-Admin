...
declare global {
  ...
  const collectBackendMatcherRoutes: typeof import('../store/modules/app/route-auth').collectBackendMatcherRoutes
  ...
  const mergeBackendStructuralRoutes: typeof import('../store/modules/app/route-auth').mergeBackendStructuralRoutes
...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { PluginDevtoolsPage, LiveTrace } from '../store/modules/app/plugin-devtools'
