...
.wiki-home__content { width: min(1080px, calc(100% - 40px)); margin: 0 auto; padding: 48px 0 72px; }
.wiki-home__intro > span { color: var(--yb-site-muted, var(--color-text-3)); font-size: 13px; font-weight: 700; }
...
.wiki-home__intro p { margin: 0; color: var(--yb-site-muted, var(--color-text-3)); }
.wiki-home__intro dl { display: flex; gap: 10px; margin: 0; }
.wiki-home__intro dl div { min-width: 100px; padding: 10px 12px; border: 1px solid var(--yb-site-border, var(--color-border-2)); border-radius: 8px; background: var(--yb-site-surface, var(--color-bg-2)); }
.wiki-home__intro dt { color: var(--yb-site-heading, var(--color-text-1)); font-size: 22px; font-weight: 700; }
.wiki-home__intro dd { margin: 2px 0 0; color: var(--yb-site-muted, var(--color-text-3)); font-size: 12px; }
...
.wiki-home__space { min-height: 185px; cursor: pointer; border: 1px solid var(--yb-site-border, var(--color-border-2)); border-radius: 10px; background: var(--yb-site-surface, var(--color-bg-2)); box-shadow: 0 1px 3px rgb(0 0 0 / 6%); transition: box-shadow .15s; }
.wiki-home__space:hover { box-shadow: 0 6px 18px rgb(0 0 0 / 10%); }
...
.wiki-home__space-content p { margin: 0; color: var(--yb-site-muted, var(--color-text-3)); font-size: 14px; line-height: 1.6; }
.wiki-home__space-content span { display: inline-flex; align-items: center; gap: 4px; margin-top: auto; color: var(--yb-site-text-2, var(--color-text-2)); font-size: 13px; font-weight: 600; }
...
.wiki-home__section-head p { margin-top: 4px; color: var(--yb-site-muted, var(--color-text-3)); font-size: 13px; }
.wiki-home__section-head > a { color: var(--yb-site-text-2, var(--color-text-2)); font-size: 13px; text-decoration: none; }
.wiki-home__recent { margin-top: 44px; }
.wiki-home__recent-list { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); border-top: 1px solid var(--yb-site-border, var(--color-border-2)); }
.wiki-home__recent-list > a { display: flex; min-width: 0; gap: 14px; align-items: center; justify-content: space-between; padding: 18px 10px 18px 0; border-bottom: 1px solid var(--yb-site-border, var(--color-border-2)); color: var(--yb-site-heading, var(--color-text-1)); text-decoration: none; }
.wiki-home__recent-list > a:nth-child(odd) { margin-right: 18px; }
.wiki-home__recent-list > a:nth-child(even) { padding-left: 18px; border-left: 1px solid var(--yb-site-border, var(--color-border-2)); }
.wiki-home__recent-list span { display: grid; min-width: 0; gap: 5px; }
.wiki-home__recent-list small { color: var(--yb-site-muted, var(--color-text-3)); }
.wiki-home__recent-list strong, .wiki-home__recent-list p { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.wiki-home__recent-list p { margin: 0; color: var(--yb-site-text-2, var(--color-text-2)); font-size: 13px; }
.wiki-home__recent-list > a > :deep(svg) { flex-shrink: 0; color: var(--yb-site-muted, var(--color-text-3)); }
...
@media (max-width: 600px) { .wiki-home__content { width: min(100% - 28px, 1080px); padding: 32px 0 56px; }.wiki-home__intro-row { align-items: stretch; flex-direction: column; }.wiki-home__intro h1 { font-size: 28px; }.wiki-home__intro dl { width: 100%; }.wiki-home__intro dl div { min-width: 0; flex: 1; }.wiki-home__search { grid-template-columns: 1fr; }.wiki-home__search :deep(button) { width: 100%; }.wiki-home__recent-list strong, .wiki-home__recent-list p { white-space: normal; overflow-wrap: anywhere; } }
</style>
